...
export default async function ProfessionalEnquiryPage({ searchParams }: {
  searchParams: Promise<{ professional?: string | string[]; service?: string | string[]; industry?: string | string[] }>;
}) {
    ...
    <div className={styles.layout}>
      <aside className={styles.intro} aria-label="Why connect with our professionals">
        ...
        <div className={styles.introContent}>
          ...
          <h1>Connect with<br />Our Professionals</h1>
          <p>Share your requirements and we will connect you with a member of our team who can help you take the next step.</p>
