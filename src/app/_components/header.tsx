        ...
        >
          {navigation.map((n) => (
            <Fragment key={n.href}>
              ...
              {n.label === "About Us" ? <AboutMenu id={"menu-" + slugify(n.label)} onNavigate={close} /> : n.label === "Professionals" ? <ProfessionalsMenu id={"menu-" + slugify(n.label)} onNavigate={close} /> : n.label === "Industries" ? <IndustriesMenu id={"menu-" + slugify(n.label)} onNavigate={close} /> : n.label === "Services" ? <ServicesMenu id={"menu-" + slugify(n.label)} onNavigate={close} /> : <div className="mega-menu" id={"menu-" + slugify(n.label)}>
