  ...
  return <div className={`${styles.page} ${estate.page} ${health.page}`}>
    <section className={`${styles.hero} ${estate.hero} ${health.hero}`} aria-labelledby="healthcare-title">
      ...
      <div className={`container ${styles.heroInner}`}>
        ...
        <div className={`${styles.heroCopy} ${health.heroCopy}`}><span className={styles.eyebrow}>Industry Focus</span><h1 id="healthcare-title">Healthcare &<br />Pharma</h1><p className={styles.tagline}>Regulatory Clarity. Ethical Growth. Healthier Tomorrow.</p><p className={styles.heroDescription}>We support healthcare providers, pharmaceutical companies, medical device manufacturers, diagnostics and allied businesses with connected legal, regulatory and business advisory solutions.</p><Link className={styles.button} href="#enquire">Speak to Our Experts<Icon name="arrow" /></Link></div>
