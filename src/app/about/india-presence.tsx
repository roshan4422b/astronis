...
export default function IndiaPresence() {
  return <div className={styles.page}>
    ...
    <details className={styles.credits}><summary>Image & map credits</summary><p>India Gate photograph: <a href="https://images.unsplash.com/photo-1587474260584-136574528ed5">Unsplash</a>. Map adapted from <a href="https://github.com/AbhinavSwami28/india-official-geojson">India GeoJSON by AbhinavSwami28</a>, <a href="/images/india-presence/MAP-LICENSE.txt">MIT license</a>. City landmark photographs: <a href="/images/india-presence/SOURCES.md">photographer credits and sources</a>.</p></details>
  </div>;
}
